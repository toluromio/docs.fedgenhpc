...
Users connect to the login from their personal computers/workstation using `ssh <https://hpcdocs.fedgen.net/en/latest/access/Working%20With%20An%20SSH%20Client.html>` before accessing other parts of the FEDGEN HPC Cluster. Users initiate their jobs primarily from the login node.
