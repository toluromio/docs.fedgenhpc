...
Users connect to the login from their personal computers/workstation using `ssh </access/Working%20With%20An%20SSH%20Client.rst>`__ before accessing other parts of the FEDGEN HPC Cluster. Users initiate their jobs primarily from the login node.
